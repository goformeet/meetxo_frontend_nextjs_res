      ...
      <div className="py-28 flex flex-col justify-center items-center">
        <Tabs defaultValue="tab-1" className="">
          <TabsList className="h-full bg-[rgba(10,_102,_194,_0.25)] rounded-[70px] p-1.5 flex justify-center max-w-fit mx-auto">
            <TabsTrigger
              className="text-primary data-[state=active]:bg-primary data-[state=active]:text-white px-6 py-3 rounded-[70px] font-plus-jakarta-sans text-sm font-bold"
              value="tab-1"
            >
              Join as Expert
            </TabsTrigger>
          ...
          <div className="mt-6 border border-[#F1F1F3] dark:border-[#2A2A2E] bg-[#FCFCFD] dark:bg-[#18181B] px-5 py-[14px] rounded-[11px] flex items-center gap-2.5 relative w-fit mx-auto">
            ...
            <h1 className="text-lg md:text-4xl lg:text-5xl font-semibold leading-normal font-plus-jakarta-sans">
              <span className="text-primary">Unlock</span> Expertise. Anytime,
              Anywhere
            </h1>
          </div>
          <TabsContent value="tab-1">
            ...
            <ExpertInput />
            <p className="text-surface-foreground text-sm md:text-base text-center mt-4">
              Don’t wait—claim your domain today!
            </p>
          </TabsContent>
